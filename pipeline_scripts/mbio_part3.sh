...
usearch --otutab "${output_dir}/phix_clean.combined.fq" -quiet -zotus "${output_dir}/asvs/asvs.fa" -otutabout "${output_dir}/asvs/asv_table_00.txt" -mapout "${output_dir}/asvs/asv_table_map.txt"
