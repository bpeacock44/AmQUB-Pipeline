...
# This script creates an excel file of the ASV table with detailed information about 
# taxonomic assignments and other relevant information for ASVs. 
...
# Define file paths
file_path <- "asv_table_03_add_seqs_norm.txt"
...
file_path4 <- "asv_table_03_add_seqs.txt"
