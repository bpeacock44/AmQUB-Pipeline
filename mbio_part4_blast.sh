...
##### This error occurs from time to time and I don't know what it is, but if I wait a bit and run the code again it is resolved.

#taxonomy db will be stored as: [/home/bpeacock_ucr_edu/real_projects/PN94_singularity_of_microbiome_pipeline/testing_on_diss_data/uni_out/asvs/rep_set/assgntax/taxonomyDB.json]
