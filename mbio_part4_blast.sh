...
echo $outfp
echo "Rscript -e \"source('${HDIR}/pipeline_helper_functions.R'); add_sequences_to_asv_table('${otblfp}', '${output_dir}/asvs/rep_set/seqs_chimera_filtered_ASVs.fasta', '${outfp}')\""
